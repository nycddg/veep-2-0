export function TrustChip({ label = "72-hour match · 30-day fit guarantee" }: { label?: string }) {
  return (
    <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-[10px] font-medium tracking-[0.16em] uppercase text-accent">
