...
function OperatorCard({ op }: { op: Operator }) {
  ...
  return (
    <article
      tabIndex={0}
      className="group relative flex-shrink-0 w-[300px] sm:w-[320px] lg:w-[340px] aspect-[3/4] snap-start overflow-hidden rounded-2xl bg-[color:var(--surface-raised)] cursor-pointer transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
