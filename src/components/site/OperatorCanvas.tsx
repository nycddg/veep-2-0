  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto px-4 md:px-0">
      ...
      <div className="relative">
        {/* Headshot slot — the single media surface in the hero */}
        <div className="relative z-10 mx-auto w-full aspect-[16/9] max-w-2xl rounded-3xl bg-[color:var(--surface-raised)] overflow-hidden">
          <img
        ...
        {/* Match matrix — the single floating callout; dark surface in both modes */}
        <div className="hidden sm:block absolute -bottom-10 right-0 md:-right-6 z-20 bg-[oklch(0.16_0.028_262)] rounded-2xl p-6 w-[260px] md:w-[280px] op-float-delayed">
